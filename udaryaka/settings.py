"""
Django settings for udaryaka project.
...
SECRET_KEY = 'django-insecure-k=_3bal5&v#9(_9*v(ox92ro)0@)33xny_6+d#v=_^1nwrtsa8'
...
WSGI_APPLICATION = 'udaryaka.wsgi.application'
...
AUTHENTICATION_BACKENDS = [
    'manage_user.auth.EmailAuthBackend',
]
